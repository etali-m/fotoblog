...
SECRET_KEY = 'django-insecure--hp_lq(boel-=g=qr@$l1s%@05!l*+5wucee22q8slz7$gi)f_'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR.joinpath('templates'), #<--- indique où django va récuperer le fichier base.html
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#pour les images ajoutées par un utilisateur
MEDIA_URL = '/media/'
